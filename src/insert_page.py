...
class Insert_Page(QtGui.QDialog):
    ...
    def initUI(self):
        ...
        self.whcdBox.addItems(['大专', '本科', '硕士', '博士', '博士后'])
        ...
        self.Commit_Button.move(600, 550)
    ...
    def Commit_Button_Event(self):
        ...
        print '---'
        resp = Base_SQL.SQL_Insert(xm, xb,mz, csny, hyzk, whcd, jkzk,zzmm,zc,jg,sfzh,byxx,zytc,hkszd,hkxz,xzz,zw,gzm,jspx,jlcf,smwt,tbrqm,tbrq,gsyj,scrq,ryxz,rcsj,ryzt,bz,szbm)
...
def main():
    ...
    ex = Insert_Page()
    ex.initUI()
    ex.setGeometry(500, 300, 750, 620)
    ex.show()
    sys.exit(app.exec_())
